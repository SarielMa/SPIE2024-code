...
def parse_opt(known=False):
    ...
    opt.name = "AT_Linf"+str(opt.epsilon_train)
    return opt
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
           ...
           # adversarial attack
            ...
            if noise > 0:
                ...
                img_adv = pgd_attack(model, imgs, targets.to(device),
                                noise_norm=noise, norm_type=np.inf, 
                                max_iter = max_iter, step = step,loss_fn = compute_loss)
